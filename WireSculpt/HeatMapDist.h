...
public: 
    ...
    //void computePhi(std::vector<Vertex*>* segments, WireSculptPlugin& ws);
...
private:
    ...
    //Eigen::VectorXd computeB(std::vector<Vertex*>* segments, WireSculptPlugin& ws);
    Eigen::VectorXd computeB(int sInput, WireSculptPlugin& ws);
